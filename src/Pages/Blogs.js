    ...
    return (
        <div className='grid gap-6 mx-16 my-4'>
            ...
            <div className='p-3 rounded-2xl bg-sky-200'>
                <h1 className='text-3xl'>Difference between authorization and authentication</h1>
                <p className='text-xl'>
                    Authentication means approve you for there require on the other hand authentication means what you can do.
                </p>
            </div>
            <div className='p-3 rounded-2xl bg-sky-200'>
                <h1 className='text-3xl'>Why are you using firebase? What other options do you have to implement authentication?</h1>
                <p className='text-xl'>
            ...
            <div className='p-3 rounded-2xl bg-sky-200'>
                <h1 className='text-3xl'> What other services does firebase provide other than authentication</h1>
